...
namespace APM.Data.Infrastructure
{
    ...
    {
        #region Properties
        private APMDBContext dataContext;
        ...
        protected APMDBContext DbContext
        {
        ...
        public async Task<T> GetOne(Expression<Func<T, bool>> predicate)
        {
            try
            {
                return await dataContext.Set<T>().Where(predicate).FirstOrDefaultAsync();
            }
            catch
            {
                return null;
        ...
        public async Task<IEnumerable<T>> Get(string storedProcedureName, params object[] parameters)
        {
            try
            {
                if (parameters != null)
                {
                    ...
                    return await dataContext.Database.SqlQuery<T>(query, parameters).ToListAsync();
                }
                else
                {
                    return await dataContext.Database.SqlQuery<T>(storedProcedureName).ToListAsync();
                }
            }
            catch
            {
        ...
        public async Task<T> GetOne(string storedProcedureName, params object[] parameters)
        {
            try
            {
                if (parameters != null)
                {
                    ...
                    return await dataContext.Database.SqlQuery<T>(query, parameters).FirstOrDefaultAsync();
                }
                else
                {
                    return await dataContext.Database.SqlQuery<T>(storedProcedureName).FirstOrDefaultAsync();
                }
            }
            catch
            {
