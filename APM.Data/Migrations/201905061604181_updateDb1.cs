    ...
    public partial class updateDb1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.UserName, t.GroupID })
                .ForeignKey("dbo.AppGroups", t => t.GroupID, cascadeDelete: true)
                .ForeignKey("dbo.AppUsers", t => t.UserName, cascadeDelete: true)
                .Index(t => t.UserName)
                .Index(t => t.GroupID);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AppUsers", t => t.UserName)
                .Index(t => t.UserName);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Orders", "UserName", "dbo.AppUsers");
            DropForeignKey("dbo.Menus", "GroupID", "dbo.MenuGroups");
            DropForeignKey("dbo.AppUserGroups", "UserName", "dbo.AppUsers");
            ...
            DropIndex("dbo.AppUserGroups", new[] { "UserName" });
