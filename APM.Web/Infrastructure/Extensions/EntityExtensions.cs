...
namespace APM.Web.Infrastructure.Extensions
{
    public static class EntityExtensions
    {
        ...
        public static void UpdateOrder(this Order order, OrderViewModel orderVm)
        {
            ...
            order.UserName = orderVm.CustomerId;
        }
        ...
        //public static void UpdateRole(this Role appRole, RoleViewModel appRoleViewModel, string action = "add")
        //{
        //    if (action == "update")
